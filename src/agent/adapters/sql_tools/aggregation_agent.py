...
from .models import AggregationResponse, AggregationFunction, ColumnMapping
from .prompts import AGGREGATION_AGENT_PROMPT
...
class AggregationAgent:
    ...
    def process(self, question: str, column_mappings: List[ColumnMapping]) -> AggregationResponse:
